...
export default function PenjualanPerMitraPerbulan({ type = 'line' }) {
  ...
  if (type === 'line') {
    ...
    state = {
      ...
      options: {
        ...
        title: {
          text: 'Total penjualan per bulan per mitra dalam setahun (dalam ton)',
          align: 'left',
        },
        grid: {
          row: {
    ...
    state = {
      ...
      options: {
        ...
        title: {
          text: `% penjualan per mitra (dalam setahun)`,
        },
        labels,
        responsive: [
          {
